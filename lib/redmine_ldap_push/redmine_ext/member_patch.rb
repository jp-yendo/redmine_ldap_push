  ...
  module RedmineExt
    module MemberPatch
      def self.included(base) # :nodoc:
        ...
        base.class_eval do 
          after_create :rlp_member_created
          after_save :rlp_member_saved
          after_destroy :rlp_member_destroyed
        end
      end

      module InstanceMethods
        
        def rlp_member_created
          LdapPushService.member_created(self)
        end
        
        def rlp_member_saved
          LdapPushService.member_saved(self)          
        end
        
        def rlp_member_destroyed
          LdapPushService.member_destroyed(self)
        end
